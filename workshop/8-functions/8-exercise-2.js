...
const maxValue2 = (num1, num2, num3, num4) => {
...
console.log(maxValue(4, 2)); // 4
console.log(maxValue(4, 2, 8, 1, 5, 10)); // 10
console.log(maxValue(4, 2, 8, 1, 5, 10, 1, 64, 2, 8, -100, 54)); // 64
